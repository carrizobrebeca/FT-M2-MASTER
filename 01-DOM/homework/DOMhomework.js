...
function buildToDo(todo, index) {
  ...
  toDoText.innerHTML = todo.description; // <span>Hacer la homework</span>
  toDoText.setAttribute("id", index); // <span id=1>Hacer la homework</span>
  ...
  // <div class="toDoShell">
  //      <span id=1 class="completeText">Hacer la homework</span>
  // </div>
...
function displayToDos() {
  // Tu código acá:
   ...
   var toDoContainer = document.getElementById("toDoContainer"); //<div id="toDoContainer" ></div>
